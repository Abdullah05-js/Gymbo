import type { BodyMapProps } from "../types/BodyMapProps";
const BodyMap = ({ onClick }: BodyMapProps) => {
  return (
    <div>
      <svg
      ...
      >
        ...
        <g
          onClick={onClick}
          id="traps"
          className="text-mw-gray hover:text-amber-400 cursor-pointer"
        >
          <path
        ...
        <g id="hands" className="text-transparent ">
          <path
        ...
        <g
          onClick={onClick}
          id="forearms"
          className="text-mw-trans hover:text-amber-400 cursor-pointer"
        >
          <path
